...
class HTMLPrettyPrinter:
    ...
    def print_timetables(self, timetables, total_combinations):
        table_id = 0
        ret = ""
        ret += intro(len(timetables), total_combinations)
        for timetable in timetables:
            table_id += 1
            ret += self.format_timetable(timetable, table_id)
        ret += outro()
        return ret
    ...
    def format_timetable(self, timetable, table_id):
        ...
        for slot in timetable.lessons:
            ...
            for time_i in range(start_i+1, end_i-1):
...
<html>
  ...
  <body>
    <p style='text-align: center'>
      ...
      <span style='%sfont: 10px verdana'>(A mostrar os 100 hor�rios mais compactos dum total de %i combina��es)</span>
    </p>
    <table border='0'>
      <tr>
        <td style='width: 50px'> <img src='images/left.png' onclick='goLeft()'> </td>
        <td style='width: 100%%'>
          ...
          <div style='display: none' id='tt%i' class='mtop15'>
            <table class='timetable' style='margin-left: auto; margin-right: auto' cellspacing='0' cellpadding='0' width='98%%'>
              <tr>
                ...
                <th colspan='1' width='14%%' id='weekday1'>Ter�a</th>
                ...
                <th colspan='1' width='14%%' id='weekday5'>S�bado</th>
              </tr>
""" % (id_number)
...
def outro():
    return """\
        ...
        <td style='width: 50px'> <img src='images/right.png' onclick='goRight()'> </td>
      </tr>
    </table>
    <script type='text/javascript'>
      showTable(current);
